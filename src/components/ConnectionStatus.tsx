...
export const ConnectionStatus: React.FC<ConnectionStatusProps> = ({
  ...
  const getStatusIcon = (isConnected: boolean, hasError: boolean, type: 'database' | 'influxdb') => {
    if (type === 'database') {
      return isConnected ? (
  ...
  return (
    <div className="fixed bottom-4 right-4 flex items-center space-x-2 bg-gray-800/80 backdrop-blur-sm px-3 py-2 rounded-lg border border-gray-700/50 shadow-lg z-50">
